    ...
    const npcs = [
      {
        ...
        greeting: "Hey! Want to talk about how you're feeling?",
      ...
      },
      {
        ...
        greeting: "Let's check your wellness metrics!",
        destination: "http://localhost:3000/neuronavdashboard",
        color: 0x64b5f6,
      },
      {
        position: new THREE.Vector3(0, 0, -14),
        name: "NeuroNav Home",
        greeting: "Welcome to the NeuroNav Hub!",
      ...
      },
      {
        ...
        name: "Therapist Meet",
        greeting: "Need someone to talk to? Connect with a therapist!",
        destination: "http://localhost:6002/",
        color: 0xba68c8,
      },
      {
        position: new THREE.Vector3(10, 0, 0),
        name: "Aura Assistant",
        greeting: "Hi! I'm your AI companion — let's chat!",
        destination: "http://localhost:3001",
        color: 0x4db6ac,
      },
    ];
